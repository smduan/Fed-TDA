...
class Table:
    ...
    def fit(self, data, discrete_columns):
        ...
        :return:
        """
        # get columns need to fit and synthese
        # if filed_name is None，fit and synthese all columns
        # if filed_name is not None，fit column in intersection of filed_name and columns
        ...
        # get data type of values in every column
